  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const nutritionDocRef = doc(db, 'nutrition_plans', clientDoc.id);
    ...
    return (
      <div className="client-content">
        <div className="client-header">
          <h1>Welcome to Coached</h1>
          <p>Client Dashboard</p>
        </div>
        
        <div className="client-welcome">
          <p>Hello, {user?.email}</p>
          <p>Complete your profile to get started with your fitness journey.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="client-dashboard-page">
      ...
      <div className="tab-content">
        ...
        {/* Weight Tracker Tab - SAME AS COACH VIEW */}
        {activeTab === 'weight' && (
          <Card>
                  ...
                  {weightEntries.length > 0 ? (
                    ...
                    <tr>
                      <td colSpan={5} style={{ textAlign: 'center', padding: '40px' }}>
                        No weight data available yet. Your coach will update your progress.
                      </td>
                    </tr>
                  )}
                </tbody>
            ...
            {bodyMeasurements.length > 0 ? (
              ...
              <Card>
                <div style={{ textAlign: 'center', padding: '60px 20px' }}>
                  ...
                  <p style={{ fontSize: '14px', color: '#9ca3af' }}>Your coach will record your measurements during check-ins.</p>
                </div>
              </Card>
            )}
          </>
        ...
        {/* Meal Plan Tab - SAME AS COACH VIEW */}
        {activeTab === 'meals' && (
          <>
        ...
        {/* Workout Plan Tab - SAME AS COACH VIEW */}
        {activeTab === 'workout' && (
          <Card className="workout-plan-card">
            ...
            {workoutLoading ? (
              ...
              <div className="empty-state">
                <p>No workout plan assigned yet. Your coach will assign one soon!</p>
              </div>
            ) : (
